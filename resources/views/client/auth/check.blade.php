...
@section('content')
    ...
    <div class="login-card">
        ...
        <form class="login-form form-group" role="form" method="POST" action="{{ route('client.login') }}">
            {{ csrf_field() }}
            <input type="hidden" name="card_id" value="{{ request()->input('card_id') ?? null }}">
            <h4>تسجيل الدخول</h4>
            <div class="label-container">
                <p>برجاء ارسال كود التحقق المرسل اليك علي
                    <span class="fw-bold">{{ request()->input('phone') ?? null }}</span>
                </p>
            </div>
            ...
            @if (count($errors) > 0 || Session::get('error'))
                <div class="text-center">
                    <span class="text-danger">{{ __('message.wrong-otp') }}</span>
                </div>
            @endif
            @error('card_id')
            <div class="text-center">
            ...
            <div class="text-center">
                ...
                <p class="massage-code blue">
                    لم يصلك كود التحقق؟ <a
                        href="{{ route('client.check.again', ['phone' => request()->input('phone') ?? null]) }}">اعادة
                        الارسال</a>
                </p>
            </div>
        </form>
                    ...
                    /***/
                        (function (module, exports) {
                            ...
                            function updateBlocks() {
                                ...
                                if (value.length < 6) digits[value.length].classList.add("focus");
                            }
